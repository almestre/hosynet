...
#################
## DESCRIPTION: function to calculate the RPD (relative phylogenetic distinctiveness) for each species of symbiont based on the hosts used by the symbiont.
...
phyloSpec.rpd <- function(dist_mat, int_mat)
{
