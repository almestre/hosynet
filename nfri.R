...
#################
## DESCRIPTION: function to calculate the geographically corrected NFRI (net functional relatedness index, also called nearest relative index) for each module of a modular interaction network (for a given partition).
...
nfri <- function(matrix, dist_matrix, partition, geo_partition = NA, level = 1, runs = 999)
{
